CREATE PROCEDURE [dbo].[AddSite]
	...
	@praticalInformation NVARCHAR(512),
...
BEGIN
	...
	VALUES (@site_Name, @site_Description, @latitude, @longitude, @length, @depth, @accessRequirement, @praticalInformation, @donneesLambda_Id, @nOwner_Id, @scientificData_Id, @bibliography_Id)
END
