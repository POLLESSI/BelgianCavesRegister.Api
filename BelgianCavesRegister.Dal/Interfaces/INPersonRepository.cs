...
namespace BelgianCavesRegister.Dal.Interfaces
{
    public interface INPersonRepository
    {
        ...
        void AddNPerson(string lastname, string firstname, DateTime birthDate, string email, string address_Street, int address_Nbr, int postalCode, string address_City, string address_Country, int telephone, int gsm);
